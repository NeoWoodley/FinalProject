...
int main() {
	...
	Shader lightingShader("/Users/neowoodley/Projects/CLionProjects/learnopengl/LightCasters/smooth_spot_light.vs", "/Users/neowoodley/Projects/CLionProjects/learnopengl/LightCasters/smooth_spot_light.frag");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glUniform1f(lightSpotCutOffLoc, glm::cos(glm::radians(12.5f)));  // 内圆锥的余弦值
		glUniform1f(lightSpotOuterCutOffLoc, glm::cos(glm::radians(17.5f)));  // 外圆锥的余弦值
