...
// 创建一个包含六个光源的场景，我们将模拟一个类似阳光的平行光和4个定点光以及一个手电筒
//
...
int main() {
	...
	Shader lightingShader("/Users/neowoodley/Projects/CLionProjects/learnopengl/MultipleLights/multiple_lights.vs",
	                      "/Users/neowoodley/Projects/CLionProjects/learnopengl/MultipleLights/multiple_lights.frag");
	Shader lampShader("/Users/neowoodley/Projects/CLionProjects/learnopengl/MultipleLights/lamp.vs",
	                  "/Users/neowoodley/Projects/CLionProjects/learnopengl/MultipleLights/lamp.frag");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// 设置uniform变量数组和设置单个uniform变量值是相似的，只需要一个合适的下表就能检索到数组中我们想要的uniform变量了
		// 在这里共需要设置28个uniform变量（4 * 7），可以尝试定义一个光源类来设置这些uniform属性来减少我们的工作
		// Point light 1
